# Checklist hoàn thiện HW03

## 1. Phạm vi cá nhân

- [x] Chọn đúng một kịch bản EMS: B.
- [x] Chọn tối thiểu ba màn hình thuộc kịch bản đã chọn: B1, B2, B4.
- [x] Xác nhận phạm vi không trùng với thành viên khác trong nhóm (sinh viên xác nhận 04/08/2026).
- [x] Dùng cùng ba màn hình cho Task 1B, Task 2 và Task 3.

## 2. Task 1 — GUI Checklist

- [x] Nhóm có checklist chung hơn 40 mục (41).
- [x] Checklist bao phủ IA-01, IA-02, IA-03 và IA-04.
...
- [x] Có Usability Report, findings đã xếp hạng và khuyến nghị.

## 4. Task 3 — Đa trình duyệt / Đa nền tảng

- [x] Mỗi trong ba màn hình có compatibility matrix.
- [x] Mỗi màn hình khai báo bao phủ 3 OS, 5 browser và 3 loại thiết bị.
- [x] Mọi ô đã chạy đều có screenshot tham chiếu trong matrix.
- [x] Screenshot compatibility có URL EMS, browser/OS/device và lớp phủ `MSSV@....edu.vn` (sinh viên xác nhận 04/08/2026).
- [x] Ô Fail có ghi chú lỗi và screenshot tham chiếu.
