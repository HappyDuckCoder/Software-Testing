...
| Báo cáo kịch bản cá nhân | `requirement/scenario-[A-B-C-D]/scenario-report.md` | [CHƯA THỰC HIỆN] |
| Thực thi checklist theo màn hình | `requirement/scenario-[A-B-C-D]/screens/` | [CHƯA THỰC HIỆN] |
| Usability Report | `requirement/scenario-[A-B-C-D]/usability-report/` | [CHƯA THỰC HIỆN] |
| Task 3 compatibility matrix | `requirement/scenario-[A-B-C-D]/compatibility-matrix/` | [CHƯA THỰC HIỆN] |
| Findings Log | `requirement/scenario-[A-B-C-D]/findings-log.md` | [CHƯA THỰC HIỆN] |
...
| Task 1B — Thực thi checklist + bug report | 15 | [ĐIỀN SAU] | `requirement/scenario-[A-B-C-D]/screens/` |
