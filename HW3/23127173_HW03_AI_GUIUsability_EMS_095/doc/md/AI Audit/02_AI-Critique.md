...
## Rà soát checklist IA-03 ngày 03/08/2026

Claude Sonnet 4.6 (thinking) được dùng để đề xuất 10 mục Navigation cho GUI checklist. Đầu ra hữu ích vì tạo được một tập điểm kiểm tra khởi đầu cho menu, breadcrumb, quay lại, deep link và thao tác bàn phím. Tuy vậy, lần rà soát của Vân cho thấy một số tên và điều kiện mô tả quá sát Pool 3 cùng các màn hình C1–C3. Nếu giữ nguyên, checklist không còn là artefact dùng chung như yêu cầu Task 1A, và có thể buộc người kiểm thử suy diễn rằng những thành phần không tồn tại trên scenario khác là lỗi.

Nhóm đã sửa theo nguyên tắc điều kiện: chỉ kiểm tra tab, breadcrumb, kéo-thả hoặc dialog khi thành phần đó xuất hiện; còn các tiêu chí về đích điều hướng, lịch sử, trạng thái active và focus được viết ở mức áp dụng xuyên scenario. AI không xác nhận được giao diện EMS đã deploy hay kết quả Pass/Fail. Vì vậy, việc đổi tên chỉ là phản biện tài liệu; từng mục vẫn phải được thực thi trên màn hình thật và ghi rõ “không áp dụng” khi widget không tồn tại.
