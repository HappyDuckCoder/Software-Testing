# Roadmap hoàn thiện HW03

| Ưu tiên | Việc cần làm | Trạng thái | Bằng chứng / đầu ra cần có |
| --- | --- | --- |
| P0 | Chạy IA01-11 (reflow 200%) trên B1, B2, B4 và cập nhật 3 log. | Chưa làm | Kết quả quan sát thật, Pass/Fail và ghi chú khi Fail. |
| P0 | Quyết định lại các dòng `N/A` của Task 1B theo yêu cầu đề chỉ dùng Passed/Failed. | Chưa làm | Log 41 mục/màn hình, nhất quán rubric. |
| P0 | Gửi finding thật qua Google Form, rồi ghi ID/timestamp vào Findings Log. | Chưa làm | Form submission và `findings-log.md` khớp nhau. |
