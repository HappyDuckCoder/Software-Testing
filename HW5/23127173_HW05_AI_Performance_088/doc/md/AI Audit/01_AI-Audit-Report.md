...
#### AI-023 · 03/09/2026 · Codex (GPT-5)

| Trường | Nội dung |
| --- | --- |
| Prompt | “Không quay được video; Agent Skills tự chấm 2/10, tổng 88; cập nhật report và link YouTube requirement.” |
| Output AI | Cập nhật bảng điểm 29 + 19 + 19 + 9 + 10 + 2 = 88; ghi rõ video chính và video demo skill chưa có; thêm [link YouTube](https://youtu.be/TF93U3aXK9M) làm tài liệu tham khảo. |
| Verdict / SV | **HỢP LỆ — tài liệu hóa trung thực.** Không dùng link tham khảo làm bằng chứng video đã quay; sinh viên chịu trách nhiệm về mức tự chấm và ZIP `_088`. |

</div>

<div class="audit-entry">

#### AI-024 · 03/09/2026 · Codex (GPT-5)

| Trường | Nội dung |
| --- | --- |
| Prompt | “Đổi tên thư mục HW5 thành `_088`, cập nhật các doc liên quan, audit và commit.” |
| Output AI | Đổi thư mục nộp thành `23127173_HW05_AI_Performance_088`; cập nhật tham chiếu README, report, checklist, script video, workflow CI, seed-reset và git commit log; giữ nguyên artefact hiệu năng. |
| Verdict / SV | **HỢP LỆ — tổ chức bài nộp.** Tên thư mục/ZIP khớp mức tự chấm 088; số liệu JTL/HTML không bị sửa để thay đổi kết quả. |
