# AI Gap Analysis - FR-10 Order State Machine

| Gap ID | AI output | Missing / incorrect item | Why AI missed it | Student fix | Evidence |
| --- | --- | --- | --- | --- | --- |
| D-GAP-01 | Generic state-machine tests may cover only happy path | User/mobile cancel must be rejected at `shipping` | Rule is split between FR-10 and mobile FR-20 | Added user-cancel tests for pending, confirmed, shipping, delivered, canceled | D-DT-05 to D-DT-09; D-BVA-05 to D-BVA-07 |
