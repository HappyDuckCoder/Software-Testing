...
| Cursor (Composer) | AI Audit & prompt log | Ghi AI-001…AI-022, appendix, disclosure, AI Critique, privacy checklist. | Xác nhận prompt/kết quả; quay video; push GitHub. |
...
**Trạng thái hiện tại (26/08/2026):** 9 browser runs hoàn tất (158P/53F/12S/5T). Fail = bug SUT theo spec oracle. AI Critique và Privacy Checklist đã hoàn thiện. Còn video, PDF export, GitHub push/issues, zip nộp.
