...
- [x] Link video đã được sinh viên cung cấp: [Task 2](https://youtu.be/sAWzvEyJ_d0), [Agent Skill](https://youtu.be/W2U25h0cyJM). Sinh viên tự kiểm tra video không lộ secret; terminal `whoami`/`hostname` được phép theo đề bài.
- [x] Mọi output AI (script, gap analysis, AI Critique) đã được sinh viên review trước khi chạy và nộp.
- [x] AI Audit Report ghi đủ phiên 17/08/2026 (AI-001…AI-019), 26/08/2026 (AI-020…AI-036) và 27/08/2026 (AI-037).
- [x] Prompt log cập nhật đủ các phiên sinh/sửa automation và audit.
- [x] HTML report (9 runs) là bằng chứng thật từ Playwright — không AI-generated/fabricated. Hai link video do sinh viên cung cấp; nội dung cần được sinh viên xác nhận trước khi nộp.
