...
- Name: feature-c-admin-orders.spec.ts >> Feature C — FR-18 Admin orders (spec oracle) @hw04-feature-c >> C-AUTO-18 [C-BVA-02] BVA: ít nhất một dòng đơn
  ...
  - generic [ref=f1e15]:
    ...
    - generic [ref=f1e17]:
      - generic [ref=f1e18]:
        ...
        - paragraph [ref=f1e20]: 50,412,000 ₫
      - generic [ref=f1e21]:
        - heading "Tổng số đơn hàng" [level=3] [ref=f1e22]
        - paragraph [ref=f1e23]: "434"
```